        ...
        <div class="card-box">
          ...
          <div class="panel-body">
            <p class="text-muted font-13">
              Hye, I’m Johnathan Doe residing in this beautiful world. I create
            ...
            <div class="text-left">
              ...
              <p class="text-muted font-13">
                <strong>Mobile :</strong><span class="m-l-15"
                  >(+12) 123 1234 567</span
                >
              </p>
              <p class="text-muted font-13">
                <strong>Email :</strong>
                <span class="m-l-15"
                  ><a
                    ...
                    class="__cf_email__"
                    data-cfemail="3c5f5358594e48545951594f7c5b515d5550125f5351"
                    >[email&#160;protected]</a
                  ></span
                >
              </p>
              ...
              <p class="text-muted font-13">
                ...
                <span class="m-l-5"
                  ><span class="flag-icon flag-icon-us m-r-5 m-t-0" title="us"
                  ></span> <span>English</span>
                </span><span class="m-l-5"
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="card-box tilebox-one">
              ...
              <span class="badge badge-custom">+11% </span><span
          ...
          <div class="col-sm-4">
            <div class="card-box tilebox-one">
              ...
              <span class="badge badge-custom">+89% </span><span
