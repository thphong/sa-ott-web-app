          ...
          <div class="user-info-list">
            <div class="">
              <ul class="contacts-block list-unstyled">
                ...
                <li class="contacts-block__item">
                  <a
                    href="/cdn-cgi/l/email-protection#8de8f5ece0fde1e8cde0ece4e1a3eee2e0"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                    ...
                    ><span
                      class="__cf_email__"
                      data-cfemail="c882a1a5a5b188afa5a9a1a4e6aba7a5"
              ...
              <ul class="list-inline mt-4">
                <li class="list-inline-item mb-0">
                  <a
                    class="btn btn-info btn-icon btn-rounded _effect--ripple waves-effect waves-light"
                ...
                <li class="list-inline-item mb-0">
                  <a
                    class="btn btn-danger btn-icon btn-rounded _effect--ripple waves-effect waves-light"
                    href="javascript:void(0);"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="list-inline-item mb-0">
                  <a
                    class="btn btn-dark btn-icon btn-rounded _effect--ripple waves-effect waves-light"
                    href="javascript:void(0);"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="user-info-list">
            <div class="">
              <ul class="contacts-block list-unstyled">
                ...
                <li class="contacts-block__item">
                  <a
                    href="/cdn-cgi/l/email-protection#56332e373b263a33163b373f3a7835393b"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                    ...
                    ><span
                      class="__cf_email__"
                      data-cfemail="cc86a5a1a1b58caba1ada5a0e2afa3a1"
                      >[email&#160;protected]</span
                    ></a
                  >
                </li>
